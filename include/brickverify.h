...
extern int k0_l,k1_l,k2_l,k3_l,k4_l,k5_l,k6_l,k7_l,k8_l,k9_l, k10_l, k11_l, k12_l, k13_l, k14_l, k15_l;
...
#pragma omp threadprivate(k0_l,k1_l,k2_l,k3_l,k4_l,k5_l,k6_l,k7_l,k8_l,k9_l, k10_l, k11_l, k12_l, k13_l, k14_l, k15_l)
/**
...
verifyBrick_numerical(const std::vector<long> &dimlist, const std::vector<long> &padding, const std::vector<long> &ghost,
  ...
  int f_k0,f_k1,f_k2,f_k3,f_k4,f_k5,f_k6,f_k7,f_k8,f_k9, f_k10, f_k11, f_k12, f_k13, f_k14, f_k15 = 0;
  // int shared_k=0;
  ...
  auto f = [&](bElem brick1/*original*/, bElem brick2/*CDC*/) -> void {
    ...
    // if (kor<=0.0000000001) ki_l++;
         if (kor<=0.0000000000000001) k15_l++;
...
#pragma omp parallel default(none) shared(f_k0,f_k1,f_k2,f_k3,f_k4,f_k5,f_k6,f_k7,f_k8,f_k9, f_k10, f_k11, f_k12, f_k13, f_k14, f_k15)
  {
#pragma omp critical
    {
      f_k0 = f_k0 + k0_l;
